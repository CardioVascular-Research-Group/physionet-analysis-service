	...
	public boolean sqrs(String sHeaderFile, String sPath, Integer begin, boolean bHighrez, Integer threshold, String sSignal, Integer time){
		...
		try {
			...
			if(bRet){
				...
				originFile.renameTo(new File(sPath + sRecord + ".qrs" + jobId));
				
				outputFilenames = new String[1];
				outputFilenames[0] = sPath + sRecord + ".qrs" + jobId;
			}else{
	...
	public boolean wqrs(String sHeaderFile, String sPath, 
		...
		try {
			...
			if(bRet){
				...
				originFile.renameTo(new File(sPath + sRecord + ".wqrs" + jobId));
				
				outputFilenames[0] = sPath + sRecord + ".wqrs" + jobId;
