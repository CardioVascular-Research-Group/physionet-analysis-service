...
public class AlgorithmDetailLookup_wqrs2csv {
	public AlgorithmServiceData details;
	public boolean verbose = true;
	
	public AlgorithmServiceData getDetails_wqrs2csv(){
		debugPrintln(" getDetails_wqrs2csv() started.");
		details = new AlgorithmServiceData();		
		  
		//-------------------------------------------------
		//-----------  wqrs2csv  -----------
		//-------------------------------------------------
		debugPrintln(" - Loading wqrs2csv details.");
		details.sAnalysisServiceURL = "http://localhost:8080/axis2/services";
		details.sServiceName = "physionetAnalysisService";
		details.sServiceMethod = "wqrs2csvWrapperType2";
		details.sDisplayShortName = "wqrs2csv";
		
		details.sToolTipDescription = "Attempts to locate QRS complexes in an ECG signal in the specified record and reads the annotation file specified by record and annotator and writes a comma-separated-value format translation of it, one annotation per line.";
		
		details.sURLreference = "http://physionet.org/physiotools/wag/sqrs-1.htm^http://physionet.org/physiotools/wag/rdann-1.htm";
		
		details.sLongDescription = "Attempts to locate QRS complexes in an ECG signal in the specified record and reads the annotation file specified by record and annotator and writes a comma-separated-value format translation of it, one annotation per line.";
		...
		debugPrintln(" - - Loading wqrs2csv afInFileTypes."); 
		...
		debugPrintln(" - - Loading wqrs2csv afOutFileTypes"); 
		...
		debugPrintln(" - - Loading wqrs2csv apAlgorithmProgrammers."); 
		...
		debugPrintln(" - - Loading wqrs2csv apWebServiceProgrammers."); 
		...
		debugPrintln(" - - Loading wqrs2csv aoAffiliatedOrgs."); 
	...
	private void debugPrintln(String text){
		if(verbose)	System.out.println("# AlgorithmDetailLookup_wqrs2csv # " + text);
	}
