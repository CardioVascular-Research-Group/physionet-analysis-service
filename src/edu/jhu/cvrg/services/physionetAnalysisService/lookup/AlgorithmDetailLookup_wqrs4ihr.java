...
public class AlgorithmDetailLookup_wqrs4ihr {
	public AlgorithmServiceData details;
	public boolean verbose = true;
	
	public AlgorithmServiceData getDetails_wqrs4ihr(){
		debugPrintln("getDetails_wqrs4ihr() started.");
		...
		debugPrintln(" - Loading wqrs4ihr Type2 details.");
		details.sAnalysisServiceURL = "http://localhost:8080/axis2/services";
		details.sServiceName = "physionetAnalysisService";
		details.sServiceMethod = "wqrs4ihrWrapperType2";
		details.sDisplayShortName = "wqrs4ihr";
		...
		debugPrintln(" - - Loading wqrs4ihr afInFileType"); 
		...
		debugPrintln(" - - Loading wqrs4ihr afOutFileTypes"); 
		...
		debugPrintln(" - - Loading wqrs4ihr apAlgorithmProgrammers."); 
		...
		debugPrintln(" - - Loading wqrs4ihr apWebServiceProgrammers."); 
		...
		debugPrintln(" - - Loading wqrs4ihr aoAffiliatedOrgs."); 
	...
	private void debugPrintln(String text){
		if(verbose)	System.out.println("# AlgorithmDetailLookup_wqrs4ihr # " + text);
	}
